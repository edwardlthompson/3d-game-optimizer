...
## [0.16.0](https://github.com/edwardlthompson/3d-game-optimizer/compare/v0.15.0...v0.16.0) (2026-07-22)
...
* catalog Connect Steam sync and ship v1.4.0 ([66c1998](https://github.com/edwardlthompson/3d-game-optimizer/commit/66c19983cbb63e8d8cb346f4794ce58435ba13aa))
...
* ship SpatialLabs Optimizer v1.5.0 (UX trust/discovery + audit) ([4d9456e](https://github.com/edwardlthompson/3d-game-optimizer/commit/4d9456eec82cd1a33a35931d64a94efaba9c8f7f))
...
* **ci:** LF shell scripts and http.test Env typing for worker lint ([a428afd](https://github.com/edwardlthompson/3d-game-optimizer/commit/a428afd54a33160d3401d2a83e101e65f05df18f))
...
* **ci:** restore check-github-ci.sh LF and gh run list line ([5fdc1a2](https://github.com/edwardlthompson/3d-game-optimizer/commit/5fdc1a271eff7d3dd1c404c155a134f9afb92422))
* **ci:** run npm ci before catalog and worker tests in pre-release gate ([8948427](https://github.com/edwardlthompson/3d-game-optimizer/commit/89484278df29720d95e1320f1e03f5c5dfab8435))
...
* **ci:** split steam-library-sync-url to satisfy file line limit ([756302d](https://github.com/edwardlthompson/3d-game-optimizer/commit/756302dad8fc2e540ada6e3c6131abe90d0f0dfe))
...
* **bootstrap:** align template migration and Cursor slash commands ([d198d92](https://github.com/edwardlthompson/3d-game-optimizer/commit/d198d92a722d4d2d62c8631a64a89f41854b9ce7))
* **deps-dev:** Bump the web-npm group in /examples/web with 3 updates ([#4](https://github.com/edwardlthompson/3d-game-optimizer/issues/4)) ([96c836f](https://github.com/edwardlthompson/3d-game-optimizer/commit/96c836fc36d0ac99711445d00a405f9fa12fb403))
* **deps-dev:** Bump the web-npm group in /examples/web with 3 updates ([#7](https://github.com/edwardlthompson/3d-game-optimizer/issues/7)) ([7ba89a2](https://github.com/edwardlthompson/3d-game-optimizer/commit/7ba89a2903a261c07e36a1355557d4b055690f66))
* **deps-dev:** Bump vite in /examples/web in the web-npm group ([#9](https://github.com/edwardlthompson/3d-game-optimizer/issues/9)) ([8245e4f](https://github.com/edwardlthompson/3d-game-optimizer/commit/8245e4fb3a86a2e0f0ea77af486c470a60481f13))
* sync release-please manifest and close stale release PR ([1c70149](https://github.com/edwardlthompson/3d-game-optimizer/commit/1c701490c348d17861fcc3fcf5bb4d8c94e86d57))
* **template:** align agent bootstrap to v0.15.0 ([597ed9c](https://github.com/edwardlthompson/3d-game-optimizer/commit/597ed9cd037b2bd8547955929a7d6e627c2612f0))


### Documentation

* archive audit sprint after /ship push to main ([fd0e525](https://github.com/edwardlthompson/3d-game-optimizer/commit/fd0e525e6c683c791d355870cfc2d57306e8eeed))
* archive v1.5.0 ship + Dependabot lag KB ([4129ad2](https://github.com/edwardlthompson/3d-game-optimizer/commit/4129ad2def27a79b3a78e180ace06aadcd17bd5a))
* audit sprint status — AGENT steps complete, push pending ([a5d4f67](https://github.com/edwardlthompson/3d-game-optimizer/commit/a5d4f67ef457a873693342a9db674b7bb6db68ce))
...
* record CI green after template v0.15.0 push ([b76bbfb](https://github.com/edwardlthompson/3d-game-optimizer/commit/b76bbfb5e3e16d404adc04223658f7a6f5f13ead))
...
* trim BUILD_PLAN to open HUMAN/AGENT work ([ac5aae2](https://github.com/edwardlthompson/3d-game-optimizer/commit/ac5aae26bfb20cad53ff5c995ed0aaae66f1c41b))
