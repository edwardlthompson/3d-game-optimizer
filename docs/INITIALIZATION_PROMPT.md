...
**Platform/Tech Stack:** WinUI 3 + .NET 8

**Purpose & Goals:** One-click glasses-free 3D PC gaming hub that detects display capabilities, maps compatible games, applies safe presets, and automates supporting tool setup with privacy-first local operation.
