...
require_file scripts/publish-product-msix.ps1
...
require_pattern scripts/publish-product-msix.ps1 'Sign' 'MSIX -Sign switch'
require_pattern scripts/publish-product-msi.ps1 'Product\.wixproj|Product\.wxs' 'WiX packaging'
require_pattern scripts/build-product-local.ps1 'SkipGate|SkipMsix|SkipMsi' 'orchestrator switches'
require_pattern packaging/msi/Product.wxs 'UpgradeCode' 'fixed UpgradeCode'
require_pattern scripts/generate-winget-manifest.sh 'msi' 'MSI installer type'
